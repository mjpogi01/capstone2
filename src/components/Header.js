    ...
    <header className="header">
      <div className="header-top">
        ...
        <div className="utility-icons">
          ...
          <div className="icon" aria-label="Account" onClick={() => setShowSignInModal(true)}>
            <svg viewBox="0 0 24 24" role="img" aria-hidden="true">
      ...
      <SignInModal 
        ...
        onOpenSignUp={() => { setShowSignInModal(false); setShowSignUpModal(true); }}
      />
      <SignUpModal 
        isOpen={showSignUpModal}
        onClose={() => setShowSignUpModal(false)}
        onOpenSignIn={() => { setShowSignUpModal(false); setShowSignInModal(true); }}
      />
    </header>
  );
};
